                ...
                <div class="axil-footer-widget">
                    ...
                    <div class="inner">
                        ...
                        <ul class="support-list-item">
                            <li><a href="mailto:support@mayans.lk"><i class="fal fa-envelope-open"></i> support@mayans.lk</a></li>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-12">
                <div class="copyright-left d-flex flex-wrap justify-content-center">
                    <ul class="quick-link">
                        <li>©2025. All rights reserved by <a target="_blank" href="#">mayans</a>.</li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-4 col-lg-12">
